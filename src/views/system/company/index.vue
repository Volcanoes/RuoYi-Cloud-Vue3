<template>
  <div class="app-container">
    ...
    <el-table-column label="营业执照号" align="center" prop="businessLicenseNo" width="120" v-if="columns[2].visible"/>
      ...
      <el-table-column label="公司展示图片" align="center" prop="icon" width="120" v-if="columns[4].visible">
        <template #default="scope">
    ...
    <el-table-column label="备注" align="center" prop="remark" width="120" v-if="columns[9].visible"/>
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="companyRef" :model="form" :rules="rules" label-width="150px">
        ...
        <el-form-item label="公司展示图片" prop="icon">
...
const columns = ref([
  ...
  {key: 4, label: `公司展示图片`, visible: true},
